...
class TargetsRequirementsAddViewModelTests: BaseTest<TargetsRequirementsAddViewModel>() {
    ...
    private val databaseRepositoryMock = mock<DatabaseRepository> {
        ...
        every { getTargetById(any()) } answers {
            flowOf(
                getMockTarget(
    ...
    override val sut by lazy {
        TargetsRequirementsAddViewModelImpl(
            contextMock,
