...
class ComplicationsRequirementsPageFragment: BoundFragment<FragmentRequirementsPageBinding>(FragmentRequirementsPageBinding::inflate) {

    companion object {
        const val KEY_REQUIREMENT_ID = "requirement_id"
        const val KEY_PAGE_TYPE = "page_type"
    }

    private val requirementId
        get() = requireArguments().getString(KEY_REQUIREMENT_ID)!!

    private val pageType
        get() = requireArguments().getSerializableCompat(KEY_PAGE_TYPE, PageType::class.java) as PageType

    private val viewModel by viewModel<ComplicationsRequirementsPageViewModel>()
    ...
    private val adapter by lazy {
        ComplicationsRequirementsPageAdapter(
    ...
    private fun setupRecyclerView() = with(binding.requirementsPageRecyclerView) {
        ...
        adapter = this@ComplicationsRequirementsPageFragment.adapter
