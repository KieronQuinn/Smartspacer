...
class NotificationTargetConfigurationAppPickerFragment: BoundFragment<FragmentConfigurationTargetNotificationAppPickerBinding>(FragmentConfigurationTargetNotificationAppPickerBinding::inflate), BackAvailable {
    ...
    private fun setupSearch() = with(binding.notificationTargetConfigurationAppPickerSearch) {
        ...
        val blur = BlurDelegate.get(
            BlurMode.View(searchBoxBlur, binding.notificationTargetConfigurationAppPickerBlurTarget, blurBackground),
            lifecycleScope
        )
        blur.setBlur(1f)
        whenResumed {
