...
class DateTargetConfigurationFragment: BaseSettingsFragment(), BackAvailable {
    ...
    private val viewModel by viewModel<DateTargetConfigurationViewModel>()
    ...
    private fun DateTarget.TargetData.getDateFormat(): String {
